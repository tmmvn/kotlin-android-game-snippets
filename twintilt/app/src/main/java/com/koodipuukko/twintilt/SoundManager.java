...
public class SoundManager
  {
    ...
    private static final boolean DEBUG = true;  // flag to set logging on and off
        ...
        if (trackId == 2)
          {
            try
              {  // parse the music uri, catch and log any errors
                bgMusic = Uri.parse("android.resource://com.koodipuukko.twintilt/" + R.raw.dstcauseway);
              }
        ...
        if (trackId == 1)
          {
            try
              {  // parse the music uri, catch and log any errors
                bgMusic = Uri.parse("android.resource://com.koodipuukko.twintilt/" + R.raw.dsthorizon);
              }
            catch (NullPointerException e)
              {
                if (DEBUG)
        ...
        if (trackId == 3)
          {
            try
              {  // parse the music uri, catch and log any errors
                bgMusic = Uri.parse("android.resource://com.koodipuukko.twintilt/" + R.raw.dstneonon);
              }
            catch (NullPointerException e)
              {
                if (DEBUG)
        ...
        if (trackId == 4)
          {
            try
              {  // parse the music uri, catch and log any errors
                bgMusic = Uri.parse("android.resource://com.koodipuukko.twintilt/" + R.raw.dstbreakout);
              }
            catch (NullPointerException e)
              {
                if (DEBUG)
        ...
        if (trackId == 5)
          {
            try
              {  // parse the music uri, catch and log any errors
                bgMusic = Uri.parse("android.resource://com.koodipuukko.twintilt/" + R.raw.dstaurora);
              }
            catch (NullPointerException e)
              {
                if (DEBUG)
